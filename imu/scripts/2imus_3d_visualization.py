    ...
    try:
        ...
        if  0 < bytes_to_read:
            ...
            if data[1] == 8:
                ...
                rotation_matrix1 = quaternions_op.get_rotation_matrix_from_quaternions(quaternions1)
                ...
                rotation_matrix2 = quaternions_op.get_rotation_matrix_from_quaternions(quaternions2)
