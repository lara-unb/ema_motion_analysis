    ...
    while True:
        try:
            ...
            if  0 < bytes_to_read:
                ...
                file_management.write_to_json_file("data/coleta2_mao3.json", 
                                               back_data, 
                                               write_mode='a')
                ...
                file_management.write_to_json_file("data/coleta2_pe3.json", 
                                               feet_data, 
                                               write_mode='a')
            ...
            plt.savefig("data/coleta2_mao_acc3"+ ".pdf") # str(time.time()) +
            plt.show()
            
            plt.plot(acc_timestamps, acc_values_feet)
            plt.savefig("data/coleta2_pe_acc3"+ ".pdf") # str(time.time()) +
            plt.show()
            break
